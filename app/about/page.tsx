    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        <div className="space-y-6">
          <p className="text-lg">
            I'm a <span className="highlight">designer and developer</span> with over 5 years of experience creating
            digital products that users love. I specialize in user interface design, front-end development.
          </p>
          ...
          <div className="pt-6">
            ...
            <div className="mt-4 border-2 border-theme-500 rounded-lg overflow-hidden">
              <SpotifyPlayer playlistId="0aGu9GaMc4Af0anGtlICFt" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="mt-12 relative">
            <div className="relative">
              <h3 className="text-xl font-semibold mb-3 bg-theme-100 dark:bg-theme-900/30 px-3 py-2 inline-block rounded-md">
                Discover More
              </h3>

              <div className="relative mt-8">
                <svg
                  className="absolute -top-12 right-32 w-24 h-24 text-theme-500 z-10"
                  viewBox="0 0 100 100"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <Link href="/more-me" className="inline-block">
                  <button className="bg-theme-500 hover:bg-theme-600 text-white px-6 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center gap-2">
                    <span>More Me</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
